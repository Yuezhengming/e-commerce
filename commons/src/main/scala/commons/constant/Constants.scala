...
object Constants {
  ...
  /**
    * session访问步长（action数量）
    */
  val STEP_SIZE_1_3 = "1_3"
  val STEP_SIZE_4_6 = "4_6"
  val STEP_SIZE_7_9 = "7_9"
  val STEP_SIZE_10_30 = "10_30"
  val STEP_SIZE_30_60 = "30_60"
  val STEP_SIZE_60 = "60"
